...
public final class SdkDemoRepository {
    ...
    public void Connect(String host, String bucketName, String user, String password) 
        throws Exception {
...
public final class SdkDemoRepository {
    ...
    public void Connect(String host, String bucketName, String user, String password) throws Exception {
